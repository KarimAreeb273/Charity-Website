<%@ Page Title="Organizations" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ManageOrganizations.aspx.vb" Inherits="zakat.icclmd.org.ManageOrganizations" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <div class="col-lg-6">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
        <%--                                    <input type="checkbox" id="chkAcknowledgement" runat="server" TabIndex="10" />--%>
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="chkAcknowledgement" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
                <div class="row">
