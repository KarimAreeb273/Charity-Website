...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <br />
  <p>
    Our platform serves as a unified hub for local Masajid (mosques) to upload their information, enabling us to effectively assess eligibility and allocate Zakat funds to deserving recipients. We have created a streamlined process that ensures transparency, efficiency, and impactful distribution of Zakat contributions.
  </p>
  <br />
  <p>
  ...
  <br />
  <p>
    Our mission goes beyond mere financial assistance. We firmly believe in fostering empowerment and sustainable change within communities. By providing a platform for Masajid to upload their information, we strengthen the network of support and enable local institutions to play an active role in addressing the needs of their congregants.
  </p>
  <br />
  <p>
  ...
  <br />
  <p>
    Join us on this journey of compassion and solidarity by becoming a vital part of our shared vision to create a society where the blessings of Zakat reach those who truly need it. Together, let us uplift lives, strengthen communities, and fulfill the divine mandate of Zakat.
  </p>
  <br />
  <p>
