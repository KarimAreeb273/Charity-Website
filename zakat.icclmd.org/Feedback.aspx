    ...
    <div class="col-lg-12">
                ...
                <table>
                  <tr>
                    ...
                    <td style="width:95%">
                      ...
                      <asp:RequiredFieldValidator runat="server" ID="valRatingRecommendation" ControlToValidate="drpRatingRecommendation" CssClass="text-danger" ErrorMessage="Satisfaction rating is required." InitialValue="0" ValidationGroup="Feedback" />
                    </td>
                  </tr>
                </table>
              </div>
                        ...
                        <div class="form-vertical">
                          <div class="form-group">
                            <div class="col-lg-10">
                              ...
                              <asp:CustomValidator ID="valOtherMostLikeToImprove" runat="server" CssClass="text-danger" ErrorMessage="An other most liked to improve value is required when Other is checked." Display="Static" ValidationGroup="Feedback" Style="white-space: nowrap"></asp:CustomValidator>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="form-horizontal">
            <div class="form-group">
              <b><asp:Label runat="server" AssociatedControlID="txtSuggestionsForImprovement" ID="lblSuggestionsForImprovement" CssClass="col-lg-2 control-label" ToolTip="Survey Question 6" Style="white-space: nowrap">6. Please Provide More Details Or Suggestions For Improvement:</asp:Label></b>
            </div>
            <div class="form-group">
              <table>
                <tr>
                        ...
                        <div class="form-vertical">
                          <div class="form-group">
                            <div class="col-lg-10">
                              ...
                              <asp:RequiredFieldValidator runat="server" ControlToValidate="txtSuggestionsForImprovement" CssClass="text-danger" ErrorMessage="The other most to improve is required when Other is checked." Display="Static" ValidationGroup="Feedback" Style="white-space: nowrap" />
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="form-horizontal">
            <div class="form-group">
              <b><asp:Label runat="server" AssociatedControlID="txtAdditionalComments" ID="lbl" CssClass="col-lg-2 control-label" ToolTip="Survey Question 7" Style="white-space: nowrap">7. Do You Have Any Additional Comments Or Feedback For Us?</asp:Label></b>
            </div>
            <div class="form-group">
              <table>
                <tr>
                        ...
                        <div class="form-vertical">
                          <div class="form-group">
                            <div class="col-lg-10">
                              ...
                              <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAdditionalComments" CssClass="text-danger" ErrorMessage="The other most to improve is required when Other is checked." Display="Static" ValidationGroup="Feedback" Style="white-space: nowrap" />
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="form-group">
                <table>
                  <tr>
                    <td style="width:5%">&nbsp;</td>
                    <td style="width:95%">
                      &nbsp;&nbsp;&nbsp;<asp:Button ID="btnSubmit" runat="server" Text="Submit Feedback" CssClass="btn btn-default" Width="150" ValidationGroup="Feedback" TabIndex="17" />
                    </td>
                  </tr>
                </table>
              </div>
