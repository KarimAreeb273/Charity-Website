              ...
              <td style="width:50%">
                <div class="col-lg-12">
                  <div class="form-horizontal">                              
                    ...
                    <div class="form-group">
                      <asp:Label runat="server" AssociatedControlID="txtMasjidName" CssClass="col-lg-2 control-label" ToolTip="Primary Masjid Name" Style="white-space: nowrap">Masjid Name:</asp:Label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group">
                      <asp:Label runat="server" AssociatedControlID="txtMasjidPhone" CssClass="col-lg-2 control-label" ToolTip="Primary Masjid Phone #" Style="white-space: nowrap">Masjid Ph #:</asp:Label>
                      <div class="col-lg-10">
              ...
              <td style="width:50%">
                <div class="col-lg-12">
                  <div class="form-horizontal">
                    ...
                    <br /><br />
                    <div class="form-group">
                      <asp:Label runat="server" AssociatedControlID="drpHighestEducation" CssClass="col-lg-4 control-label" ToolTip="Highest Education Completed" style="white-space: nowrap; position: relative; top: 0px;">Highest Education Compl.:</asp:Label>
                      <div class="col-lg-8">
                ...
                <div class="col-lg-12">
                  ...
                  <div class="form-horizontal">
                    ...
                    <asp:Panel ID="pnlInternational" runat="server" Visible="false">
                      <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="drpSchoolCountry" CssClass="col-lg-2 control-label" ToolTip="Address Country" Style="white-space: nowrap; position: relative; top: 0px;">Sch. Country:</asp:Label>
                        <div class="col-lg-10">
