                        ...
                        <div class="col-lg-9">
                            <table style="width: 280px" border="0">
                                <tr>
                                    <td>$</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtDonationAmount" CssClass="form-control" autocomplete="off" type="tel" ToolTip="Donation Amount" MaxLength="3" placeholder="" TabIndex="3" Style="text-align: right" Enabled="true" /></td>
                                    <td>.00</td>
                                </tr>
                            </table>
            ...
            <div class="col-lg-6">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <asp:TextBox runat="server" ID="txtDonationDate" CssClass="form-control" ToolTip="Donation Date" placeholder="mm/dd/yyyy" TabIndex="2" Enabled="False" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <asp:DropDownList ID="drpOrganization" runat="server" ToolTip="Organization" CssClass="form-control" Style="max-width: 100%; padding-left: 0px; padding-right: 0px" TabIndex="4" Width="300px"></asp:DropDownList>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <asp:Button ID="btnDonation" runat="server" Text="Make Donation" CssClass="btn btn-success" TabIndex="5" Width="150" ValidationGroup="donate" />
                    </div>
                </div>
            </div>
        </div>
