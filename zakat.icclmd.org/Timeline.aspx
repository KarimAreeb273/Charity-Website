<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Timeline.aspx.vb" Inherits="zakat.icclmd.org.Timeline" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
  <br />
  <div class="row">
    <div class="col-lg-12">
      <%--<asp:Panel ID="pnlTimelineYes" runat="server" Visible="false">--%>
      ...
      <%--</asp:Panel>
      <asp:Panel ID="pnlTimelineNo" runat="server" Visible="false">
        <div class="well well-lg" style="text-align:justify; background-color: darkgreen; color: white">
          <h2>You currently do not have any submitted applications</h2>
        </div>
      </asp:Panel>--%>
    </div>
  </div>  
