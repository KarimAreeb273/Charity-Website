<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Eligible.aspx.vb" Inherits="zakat.icclmd.org.Eligible" %>
            ...
            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="form-vertical">
                            <div class="form-group">
                                ...
                                <br />
                                <div class="col-lg-12">
                                    <asp:TextBox runat="server" ID="txtSavings" AutoCompleteType="Disabled" CssClass="form-control" ToolTip="Savings" TabIndex="1" AutoPostBack="True" Placeholder="$" />
                                </div>
                            </div>
                            <br />
                            <br />
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <asp:TextBox runat="server" ID="txtJewelry" AutoCompleteType="Disabled" CssClass="form-control" ToolTip="Jewelry" TabIndex="2" AutoPostBack="True" Placeholder="$" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <asp:TextBox runat="server" ID="txtValue" AutoCompleteType="Disabled" CssClass="form-control" ToolTip="Value" TabIndex="3" AutoPostBack="True" Placeholder="$" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <asp:TextBox runat="server" ID="txtLoans" AutoCompleteType="Disabled" CssClass="form-control" ToolTip="Loans" TabIndex="4" AutoPostBack="True" Placeholder="$" />
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <asp:TextBox runat="server" ID="txtDebt" AutoCompleteType="Disabled" CssClass="form-control" ToolTip="Debt" TabIndex="5" AutoPostBack="True" Placeholder="$" />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDebt" CssClass="text-danger" ErrorMessage="The first name is required." Display="Static" ValidationGroup="donate" />
                        </div>
                    </div>
                    <br />
                    <br />
                    ...
                    <div class="col-lg-12">
                        <asp:TextBox runat="server" ID="txtNet" CssClass="form-control" ToolTip="Net" TabIndex="6" AutoPostBack="True" Enabled="True" Text="0.00" BackColor="silver" />
