...
UPDATE [zakat].[dbo].[APPLICATION] set [zakat].[dbo].[APPLICATION].[draftedOn] = (select [zakat].[dbo].[APPLICATION].updatedOn);
GO
...
UPDATE [ph14095182591_iccl_zakat].[dbo].[APPLICATION] set [draftedOn] = (select [ph14095182591_iccl_zakat].[dbo].[APPLICATION].updatedOn);
GO
